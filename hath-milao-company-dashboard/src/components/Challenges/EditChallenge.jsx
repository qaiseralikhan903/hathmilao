...
// Validation Schema
import ChallengeSchema from "../../validationSchemas/Challenge/AddChallengeSchema.js";
...
export default class EditChallenge extends React.Component {
  ...
  componentWillMount() {
    ...
    const blocksFromHtml = htmlToDraft(challenge.description);
    if (blocksFromHtml) {
    ...
    this.setState({
      ...
      applybefore: challenge.applybefore,
      postingdate: challenge.postingdate,
      requireddegree: challenge.requireddegree,
      requiredSkill: challenge.requiredSkill,
      city: challenge.city,
      country: challenge.country,
      field: challenge.field,
      challengeid: challenge._id,
      teamMember: challenge.teamMember,
      editorState,
      Loading: true
    });
  }
  ...
  EditchallengeFormHandler = event => {
    ...
    Joi.validate(this.state, ChallengeSchema, (err, value) => {
      if (err === null) {
        let data = this.state;
      ...
      <>
        {this.state.Loading ? (
                  ...
                  <Col>
                    ...
                    <FormGroup>
                      <Button
                        ...
                        onClick={this.EditchallengeFormHandler}
                      >
          ...
          <CardBody>
            ...
            >
              <Spin tip="Loading Edit Challenge..." size="large" />
            </div>
          </CardBody>
        )}
      </>
